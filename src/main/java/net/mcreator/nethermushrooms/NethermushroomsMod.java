package net.mcreator.nethermushrooms;
...
@Mod("nethermushrooms")
public class NethermushroomsMod {
	public static final Logger LOGGER = LogManager.getLogger(NethermushroomsMod.class);
	public static final String MODID = "nethermushrooms";

	public NethermushroomsMod() {
		// Start of user code block mod constructor
		// End of user code block mod constructor
		MinecraftForge.EVENT_BUS.register(this);
		IEventBus bus = FMLJavaModLoadingContext.get().getModEventBus();

		NethermushroomsModItems.REGISTRY.register(bus);
